...
class SimpleAPI:
    def __init__(self, bot: Bot, dp: Dispatcher):
        ...
        self.client = AsyncClient(
            ...
            headers={"Authorization": appSettings.apiSettings.authToken},
        )
    ...
    async def get(self, **kwargs):
        ...
        response: Response = await self.client.get(path, params=params)
    ...
    async def get_detail(self, **kwargs):
        ...
        response: Response = await self.client.get(f"{path}/{detailUrl}", params=params)
        return response, method
    ...
    async def post(self, **kwargs):
        ...
        response: Response = await self.client.post(path, data=data)
        return response, method
    ...
    async def patch(self, **kwargs):
        ...
        response: Response = await self.client.patch(f"{path}/{detailUrl}", data=data)
        return response, method
